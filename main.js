...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
			...
			await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ CREEPY-MD ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: CREEPY_TEACHNOLOGY`))
            console.log(chalk.magenta(`${themeemoji} GITHUB:https://github.com/Daniel432-gift `))
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: https://www.instagram.com/mr.blender5?igsh=MWhzdWh4NWE4ZjNjeg== `))
            console.log(chalk.magenta(`${themeemoji} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${themeemoji} CREDIT: DANNY\n`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
